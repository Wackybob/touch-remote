kiva.ui.LoanInfo = Ext.extend(Ext.Panel, {
    ...
    initComponent : function() {
        ...
        if (this.data.terms.scheduled_payments) {
        ...
        // Map card
        var geo = this.data.location.geo.pairs.split(' ');
        ...
        this.dockedItems = {
            xtype: 'button',
            text: '<a href="http://www.kiva.org/lend/' + this.data.data.id + '" target="_blank">Lend $25</a>',
            ui: 'action',
            dock: 'bottom'
        };
    ...
    updateCards : function() {
        this.basicCard.update(this.data);       
        this.paymentsCard.update(this.data.terms.scheduled_payments);
    }
});
